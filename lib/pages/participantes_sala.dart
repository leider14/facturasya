...
class _ParticipantesSalaState extends State<ParticipantesSala> {
  ...
  late String idHost;
  String equipoCapitan1 = 'equipo1';
  String equipoCapitan2 = 'equipo2';
  bool capitan1seleccionando = true;
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text("Participantes: $nParticipantes")
                      ],
                    )
                  ],
                ),
  ...
  Widget myWdgListParticipantes(Map data) {
    ...
    data.forEach((key, value) {
      participantes.add(GestureDetector(
        onTap: () {
          myWdgDialogConfirm(
            context: context,
            title:
                "${capitan1seleccionando ? 'Capitan 1' : 'Capitan 2'} Selecciona jugador",
            content:
                "¿Está seguro de seleccionar a ${value['username']} para tu equipo?",
            onConfirmPressed: () {
              if (capitan1seleccionando) {
                //esta el capitan 1 seleccionando
                SalaService().actualizarEquipo(
                    widget.codigoSala, value["uid"], equipoCapitan1);
              } else {
                //esta el capitan 2 seleccionando
                SalaService().actualizarEquipo(
                    widget.codigoSala, value["uid"], equipoCapitan2);
              }
              setState(() {
                capitan1seleccionando = !capitan1seleccionando;
              });
            },
          );
        },
                ...
                MyWdgButtonIcon(
                  ...
                  onPressed: () {
                    myWdgDialogConfirm(
                      ...
                      content:
                          "¿Está seguro de eliminar a ${value['username']} de la sala?",
                      onConfirmPressed: () {
